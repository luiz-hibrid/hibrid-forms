...
export default async function ResultsPage({
  ...
  const { data: subs } = await sb
    .from("submissions")
    .select(
      "id,nome,email,telefone,answers,score,tier,qualified,status,stage,labels,tracking,geo_uf,geo_city,geo_country,gads_status,gads_error,gads_sent_at,created_at,updated_at"
    )
